...
public class Amiga1200Gui {
	...
	public static JPanel amigaTab(final Amiga1200Config config) {
		...
		final JRadioButton rdbtnStdButton = new JRadioButton("PAL 320x256 - 256 colors with dithering option");
		...
		final JRadioButton rdbtnHAMButton = new JRadioButton("PAL 320x256 - Hold And Modify (without dithering)");
