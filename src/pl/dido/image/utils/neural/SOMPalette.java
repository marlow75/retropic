...
public class SOMPalette {
	...
	/**
	 * Inicjalizacja losuj�c kolory z danych wej�ciowych (je�li dost�pne) � szybsza
	 * konwergencja.
	 */
	...
	/**
	 * Trenuje sie� na dostarczonych pr�bkach (rgb jako byt�w: r,g,b,r,g,b,...).
	 * Zwraca palet� jako tablic� [width*height][3].
	 */
	public int[][] train(final byte rgb[]) {
		// Inicjalizacja: staraj si� inicjalizowa� z pr�bek je�li s� dost�pne
		...
		// przygotuj tablic� indeks�w pr�bek do shuffle
		...
		for (int e = 0; e < epochs; e++) {
			...
			// wyk�adnicze t�umienie (mo�na dobra� wsp�czynnik, tu proste exp(-t/epochs))
			...
			// dla ka�dej pr�bki (w permutowanej kolejno�ci)
	...
	protected void learn(final Position best, final int r, final int g, final int b, final float currentRate,
		...
		for (int y = 0; y < height; y++) {
			...
			for (int x = 0; x < width; x++) {
				...
				// wp�yw gaussowski z odleg�o�ci kwadratowej
	...
	/**
	 * Znajd� BMU (Best Matching Unit) u�ywaj�c odleg�o�ci kwadratowej w przestrzeni
	 * kolor�w.
	 */
