...
public class DitheringComboBox extends JExComboBox implements ActionListener {
	...
	private static final boolean standardSetup[] = new boolean[] { true, true, true, true, true, true, true, true, true };
	private static final String ditherOptions[] = new String[] { "none", "floyds", "apple", "bayer2x2", "bayer4x4", "bayer8x8", "bayer16x16", "noise8x8", "noise16x16" };
